...
class Hospital:
    def __init__(self,root):
        ...
        self.root.geometry("1540x80+0+0")
...
# ===================DATAFRAME=============
        ...
        lblNameTablet=Label(DataframeLeft,text="Names of Tablet",font=("times new romam",12,"bold"),padx=2,pady=6)
        lblNameTablet.grid(row=0,column=0)

        comNametablet=ttk.Combobox(DataframeLeft,textvariable=self.Nameoftablets,font=("times new romam",12,"bold"),width=33)
        comNametablet["values"]=["Nice","Corana Vaccine","Acetaminophen","Amlodipine","Ativan"]
        ...
        lblSideeffects=Label(DataframeLeft,font=("arial",12,"bold"),text="Doctor name",padx=2,pady=6)
        lblSideeffects.grid(row=8,column=0,sticky=W)
        txtSideeffects=Entry(DataframeLeft,font=("arial",13,"bold"),textvariable=self.sideEfect,width=35)
        txtSideeffects.grid(row=8,column=1)

        lblFurtherinfo=Label(DataframeLeft,font=("arial",12,"bold"),text="Qualification",padx=2,pady=6)
        lblFurtherinfo.grid(row=0,column=2,sticky=W)
        txtFurtherinfo=Entry(DataframeLeft,font=("arial",12,"bold"),textvariable=self.FurtherInformation,width=35)
        txtFurtherinfo.grid(row=0,column=3)

        lblBloodPresuure=Label(DataframeLeft,font=("arial",12,"bold"),text="Room no.",padx=2,pady=6)
        lblBloodPresuure.grid(row=1,column=2,sticky=W)
        txtBloodPresuure=Entry(DataframeLeft,font=("arial",12,"bold"),textvariable=self.DrivingUsingMachine,width=35)
        txtBloodPresuure.grid(row=1,column=3)

        lblStorage=Label(DataframeLeft,font=("arial",12,"bold"),text="StorageAdvice",padx=2,pady=6)
        lblStorage.grid(row=2,column=2,sticky=W)
        txtStorage=Entry(DataframeLeft,font=("arial",12,"bold"),textvariable=self.StorageAdvice,width=35)
        txtStorage.grid(row=2,column=3)

        lblMedicine=Label(DataframeLeft,font=("arial",12,"bold"),text="Bed no.",padx=2,pady=6)
    ...
    def iPrescription(self):
        ...
        self.txtPrescription.insert(END,"Doctor name:\t\t\t"+self.sideEfect.get() +"\n")
        self.txtPrescription.insert(END,"Qualification:\t\t\t"+self.FurtherInformation.get() +"\n")
        self.txtPrescription.insert(END,"StorageAdvice:\t\t\t"+self.StorageAdvice.get() +"\n")
        self.txtPrescription.insert(END,"Bed no.:\t\t\t"+self.DrivingUsingMachine.get() +"\n")
